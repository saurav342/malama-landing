...
import '../../styles/components/FloatingStoreButtons.css';

const FloatingStoreButtons = () => {
    const phoneNumber = '917975612340';
    const whatsappLink = `https://wa.me/${phoneNumber}`;

    return (
        <div className="floating-store-buttons">
            <a
            ...
            >
                <i className="button-icon">
                    <img src="/img/play-store-icon.png" alt="Play Store" />
                </i>
            </a>
            <a
                href={whatsappLink}
